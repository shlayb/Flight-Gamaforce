...
export default function Header() {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${isFloating ? 'p-2' : 'p-0'}`}>
      <div
        className={`px-6 md:px-10 h-16 md:h-20 flex justify-between items-center transition-all duration-500 max-md:px-4 ${isFloating ? 'rounded-2xl' : 'rounded-b-2xl'} ${isMenuOpen ? 'rounded-b-none' : ''}`}
        style={{
